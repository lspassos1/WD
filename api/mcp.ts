...
const TOOL_REGISTRY: ToolDef[] = [
  ...
  },
  {
    ...
    description: 'Per-country macroeconomic indicators from IMF WEO (~210 countries, monthly cadence), plus financial-system exposure seeds from World Bank IDS, BIS LBS, and FATF listings. Bundles fiscal/external balance (inflation, current account, gov revenue/expenditure/primary balance, CPI), growth & per-capita (real GDP growth, GDP/capita USD & PPP, savings & investment rates, savings-investment gap), labor & demographics (unemployment, population), external trade (current account USD, import/export volume % changes), external debt, cross-border banking exposure, and AML/CFT listing risk. Latest available year per series. Use for country-level economic screening, peer benchmarking, and stagflation/imbalance flags. NOTE: export/import LEVELS in USD (exportsUsd, importsUsd, tradeBalanceUsd) are returned as null — WEO retracted broad coverage for BX/BM indicators in 2026-04; use currentAccountUsd or volume changes (import/exportVolumePctChg) instead.',
    inputSchema: { type: 'object', properties: {}, required: [] },
    _cacheKeys: [
    ...
    _freshnessChecks: [
      ...
      { key: 'seed-meta:economic:wb-external-debt', maxStaleMin: 100800 },
      { key: 'seed-meta:economic:bis-lbs', maxStaleMin: 14400 },
      { key: 'seed-meta:economic:fatf-listing', maxStaleMin: 60480 },
    ],
  },
  {
    name: 'get_country_resilience',
    description: 'Country resilience ranking and component seeds used by the resilience model. Includes aggregate ranking, static annual country inputs, monthly recovery-capacity inputs (fiscal space, reserve adequacy, external debt, import concentration, fuel stocks, re-export share, sovereign wealth), and weekly energy-system resilience inputs (low-carbon generation, fossil electricity share, power losses). Use for country resilience screening, recovery-capacity analysis, and explaining why a country ranks above or below peers.',
    inputSchema: { type: 'object', properties: {}, required: [] },
    _cacheKeys: [
      'resilience:ranking:v17',
    ...
    _seedMetaKey: 'seed-meta:resilience:ranking',
    _maxStaleMin: 720,
    _freshnessChecks: [
      { key: 'seed-meta:resilience:ranking', maxStaleMin: 720 },
      { key: 'seed-meta:resilience:static', maxStaleMin: 576000 },
      ...
      { key: 'seed-meta:resilience:recovery:reexport-share', maxStaleMin: 86400 },
      { key: 'seed-meta:resilience:recovery:sovereign-wealth', maxStaleMin: 86400 },
      { key: 'seed-meta:resilience:low-carbon-generation', maxStaleMin: 11520 },
      { key: 'seed-meta:resilience:fossil-electricity-share', maxStaleMin: 11520 },
      { key: 'seed-meta:resilience:power-losses', maxStaleMin: 11520 },
    ],
  },
  {
